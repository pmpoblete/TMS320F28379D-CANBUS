...
/*** Compiler Required Sections ***/
  ...
  /* Program memory (PAGE 0) sections */
   .text               : {}>> RAMLS4 |RAMLS5| RAMGS0123, PAGE = 0 //RAMGS0123. Fill SL4, then SL5, then 0123
   .cinit              : > RAMGS0123,                PAGE = 0 //RAMGS0123
   .const              : > RAMGS0123,                PAGE = 0 //RAMGS0123
   .econst             : > RAMGS0123,             	 PAGE = 0 //RAMGS0123
   .pinit              : > RAMGS0123,                PAGE = 0 //RAMGS0123
   .reset              : > RESET,                    PAGE = 0, TYPE = DSECT  /* Not using the .reset section */
   .switch             : > RAMGS0123,                PAGE = 0 //RAMGS0123
